...
export function PublicResourcesPage(){
  ...
  return <>
    <section className="page-hero"><div className="container"><span className="kicker">KHO TÀI LIỆU CÔNG KHAI</span><h1>Tài liệu Nhà Hán Ngữ</h1><p>Tài liệu công khai được phục vụ trực tiếp từ kho lưu trữ R2, không phụ thuộc vào D1 để tải xuống.</p></div></section>
    <section className="section"><div className="container">
      ...
      {!loading&&!error&&!filtered.length&&<div className="empty-state">Chưa có tài liệu công khai.</div>}
