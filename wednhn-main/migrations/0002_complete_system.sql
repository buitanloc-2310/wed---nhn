...
ALTER TABLE media ADD COLUMN folder TEXT DEFAULT 'uploads';
ALTER TABLE media ADD COLUMN width INTEGER;
ALTER TABLE media ADD COLUMN height INTEGER;
ALTER TABLE media ADD COLUMN updated_at TEXT DEFAULT CURRENT_TIMESTAMP;
...
ALTER TABLE exams ADD COLUMN description TEXT DEFAULT '';
ALTER TABLE exams ADD COLUMN instructions TEXT DEFAULT '';
ALTER TABLE exams ADD COLUMN total_points REAL DEFAULT 50;
ALTER TABLE exams ADD COLUMN updated_by TEXT;
ALTER TABLE exam_attempts ADD COLUMN visitor_token TEXT;
ALTER TABLE exam_attempts ADD COLUMN status TEXT DEFAULT 'in_progress';
ALTER TABLE exam_answers ADD COLUMN updated_at TEXT DEFAULT CURRENT_TIMESTAMP;
